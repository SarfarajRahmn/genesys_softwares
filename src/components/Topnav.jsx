...
export default function NavbarWithDropdown() {
  ...
  return (
    <nav className="bg-[#EA2127] px-8 lg:px-12 md:px-[86px] pe-5 pt-[13px] flex justify-between items-start flex-wrap transition-shadow duration-300">
      <div className="font-semibold flex md:flex-row align-middle justify-center items-center space-y-4 space-x-2 lg:space-x-6 md:space-y-0 md:space-x-5">
        <img
          src={logo}
          className="max-h-[40px] md:max-h-[115px] max-w-[60px] md:max-w-[115px] lg:max-w-[70px] lg:max-h-[70px] object-contain filter invert"
          alt="Valuetainment logo"
        />
        <p className="font-[Montserrat] uppercase text-white font-extrabold text-[23px] md:text-[72px] lg:text-[81px] tracking-widest ">
          vtmerch
        </p>
      </div>

      <ul className="flex items-center justify-between lg:mt-2 text-slate-900 dark:text-gray-100 lg:gap-6">
